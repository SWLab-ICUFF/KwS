...
class MitreUtils {
	...
	/**
	 *  Retrieve a complete graph, with all minimum path costs from all vertices to all others
	 *  Algorithm elaborated by Floyd-Warshall
	 */
	...
	/**
	 *  Validate if minimal spanning tree does not has vertices from R with degree smaller than 2
	 */
